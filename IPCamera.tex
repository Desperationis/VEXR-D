...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/On5Skype}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/On5Jami}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/On5IPCam}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/BladeSkype}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/BladeJami}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/BladeIPCam}
    \caption{
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/StyloSkype}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/StyloJami}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{IPCamera/StyloIPCam}
    \caption{

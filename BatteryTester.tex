\section{[Completed] A Simple Battery Meter}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=7cm,keepaspectratio=true]{BatteryTesterPortable}
    \includegraphics[width=\textwidth,height=7cm,keepaspectratio=true]{BatteryTesterPortInside}
    \caption{

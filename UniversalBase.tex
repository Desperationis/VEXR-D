...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio=true]{UniversalBase/CADChassis}
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio=true]{UniversalBase/V1}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{UniversalBase/OGWheels}
    \includegraphics[width=\textwidth,height=3cm,keepaspectratio=true]{UniversalBase/CADWheels}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=6cm,keepaspectratio=true]{UniversalBase/SuperWheel}
    \caption{
        A super wheel.
    }
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=5cm,keepaspectratio=true]{UniversalBase/V1}
    \includegraphics[width=\textwidth,height=5cm,keepaspectratio=true]{UniversalBase/OGWheels}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=5cm,keepaspectratio=true]{UniversalBase/V2Front}
    \includegraphics[width=\textwidth,height=5cm,keepaspectratio=true]{UniversalBase/V2Side}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=6cm,keepaspectratio=true]{UniversalBase/V4}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio=true]{UniversalBase/SuperWheel}
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio=true]{UniversalBase/V5Front}
    \includegraphics[width=\textwidth,height=4cm,keepaspectratio=true]{UniversalBase/V5Side}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth,height=7cm,keepaspectratio=true]{UniversalBase/V5CAD}
    \caption{
